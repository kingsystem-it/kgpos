...
<head>
  ...
  <style>
    :root { --bg:#0b0f12; --card:#12181d; --muted:#94a3b8; --ok:#16a34a; --warn:#f59e0b; --text:#e2e8f0; --accent:#38bdf8; }
    * { box-sizing:border-box; }
    body { margin:0; font-family:system-ui,-apple-system,"Segoe UI",Roboto,sans-serif; background:var(--bg); color:var(--text); }
    header { display:flex; align-items:center; justify-content:space-between; padding:14px 20px; border-bottom:1px solid #1f2937; }
    header h1 { font-size:18px; margin:0; letter-spacing:.5px; }
    .controls { display:flex; gap:8px; align-items:center; }
    .badge { display:inline-block; padding:2px 8px; border-radius:999px; font-size:12px; color:#0b1115; margin-left:8px; }
    .tabs { display:flex; gap:8px; padding:12px 20px; border-bottom:1px solid #1f2937; align-items:center; }
    .tabs button { background:#0e141a; color:var(--text); border:1px solid #1f2937; padding:8px 12px; border-radius:8px; cursor:pointer; }
    .tabs button.active { border-color:var(--accent); box-shadow:0 0 0 1px var(--accent) inset; }
    .content { display:grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap:12px; padding:16px; }
    .card { background:var(--card); border:1px solid #1f2937; border-radius:16px; padding:16px; display:flex; flex-direction:column; gap:10px; }
    .row { display:flex; align-items:center; justify-content:space-between; gap:8px; }
    .name { font-size:22px; font-weight:700; letter-spacing:.2px; }
    .qty { font-size:18px; color:var(--muted); font-weight:600; }
    .meta { display:flex; gap:10px; align-items:center; color:var(--muted); font-size:12px; flex-wrap:wrap; }
    .btn { border:1px solid #1f2937; background:#0e141a; color:var(--text); padding:10px 12px; border-radius:10px; cursor:pointer; font-size:14px; }
    .btn:hover { border-color:#334155; }
    .btn.ok { border-color:#14532d; background:#0b1912; }
    .btn.warn { border-color:#7c2d12; background:#1a120b; }
